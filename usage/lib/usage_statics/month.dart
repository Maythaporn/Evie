...
import '../financial_statics/financial.dart';
...
class usage_month_homepage extends StatefulWidget {
  @override
  _usage_month_homepageState createState() => _usage_month_homepageState();
}

class _usage_month_homepageState extends State<usage_month_homepage> {
  int selectedIndex = 0;
...
class usage1_month_homepage extends StatefulWidget {
  @override
  _usage1_month_homepageState createState() => _usage1_month_homepageState();
}

class _usage1_month_homepageState extends State<usage1_month_homepage> {
  int selectedIndex = 0;
...
class usage2_month_homepage extends StatefulWidget {
  @override
  _usage2_month_homepageState createState() => _usage2_month_homepageState();
}

class _usage2_month_homepageState extends State<usage2_month_homepage> {
  int selectedIndex = 0;
