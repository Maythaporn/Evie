...
class usage_date_homepage extends StatefulWidget {
  @override
  _usage_date_homepageState createState() => _usage_date_homepageState();
}

class _usage_date_homepageState extends State<usage_date_homepage> {
  int selectedIndex = 0;
...
class usage1_date_homepage extends StatefulWidget {
  @override
  _usage1_date_homepageState createState() => _usage1_date_homepageState();
}

class _usage1_date_homepageState extends State<usage1_date_homepage> {
  int selectedIndex = 0;
...
class usage2_date_homepage extends StatefulWidget {
  @override
  _usage2_date_homepageState createState() => _usage2_date_homepageState();
}

class _usage2_date_homepageState extends State<usage2_date_homepage> {
  int selectedIndex = 0;
